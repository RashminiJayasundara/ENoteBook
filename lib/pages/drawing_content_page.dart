...
class DrawingContentPage extends StatefulWidget {
  int id;
  DrawingContentPage({required this.id});

  @override
  _DrawingContentPage createState() => _DrawingContentPage();
}

class _DrawingContentPage extends State<DrawingContentPage> {
